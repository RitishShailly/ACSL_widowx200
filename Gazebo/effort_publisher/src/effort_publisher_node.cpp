...
/***** this function is used to get the character from the terminal*******/
char getch()
{
...
int main(int argc, char **argv)
{
	...
	std::string path = file_path+"/data.dat"; /* path for data.dat file used to store current and refernce positions of the joints*/
	...
	while(ros::ok()) /* check for the rosmaster is on or off*/
	{
		...
		{
		/*get the input from user and change the reference position of joints*/
		ch = getch();
		if(ch == 'q')
		{
...
/* plot the graph for each joint using GNU Plot*/
system("gnuplot -p -e \"set title 'waist trajectory'; set xlabel 'Time(secs)'; set ylabel 'Angles(rads)';plot'~/interbotix_ws/src/Interbotix_src/Gazebo/Data_log/data.dat' using 1:2 title 'reference trajectory' with lines, '~/interbotix_ws/src/Interbotix_src/Gazebo/Data_log/data.dat' using 1:3 title 'current trajectory' with lines \"");
system("gnuplot -p -e \"set title 'shoulder trajectory'; set xlabel 'Time(secs)'; set ylabel 'Angles(rads)';plot '~/interbotix_ws/src/Interbotix_src/Gazebo/Data_log/data.dat' using 1:4 title 'reference trajectory' with lines, '~/interbotix_ws/src/Interbotix_src/Gazebo/Data_log/data.dat' using 1:5 title 'current trajectory' with lines\"");
system("gnuplot -p -e \"set title 'elbow trajectory'; set xlabel 'Time(secs)'; set ylabel 'Angles(rads)'; plot '~/interbotix_ws/src/Interbotix_src/Gazebo/Data_log/data.dat' using 1:6 title 'reference trajectory' with lines, '~/interbotix_ws/src/Interbotix_src/Gazebo/Data_log/data.dat' using 1:7 title 'current trajectory' with lines\"");
system("gnuplot -p -e \"set title 'wrist angle trajectory'; set xlabel 'Time(secs)'; set ylabel 'Angles(rads)'; plot '~/interbotix_ws/src/Interbotix_src/Gazebo/Data_log/data.dat' using 1:8 title 'reference trajectory' with lines, '~/interbotix_ws/src/Interbotix_src/Gazebo/Data_log/data.dat' using 1:9 title 'current trajectory' with lines\"");
system("gnuplot -p -e \" set title 'wrist rotate trajectory'; set xlabel 'Time(secs)'; set ylabel 'Angles(rads)'; plot '~/interbotix_ws/src/Interbotix_src/Gazebo/Data_log/data.dat' using 1:10 title 'reference trajectory' with lines, '~/interbotix_ws/src/Interbotix_src/Gazebo/Data_log/data.dat' using 1:11 title 'current trajectory' with lines\"");
